...
export const ui = {
  ...
  ms: {
    locale: {
      label: 'Bahasa',
      switchTo: 'Tukar ke Bahasa Melayu',
      current: 'Bahasa Melayu',
    },
    common: {
      products: 'Produk',
      industries: 'Industri',
      allIndustries: 'Lihat semua industri',
      exploreIndustry: 'Terokai dashboard {name}',
      blog: 'Blog',
      careers: 'Kerjaya',
      contact: 'Hubungi',
      soon: 'Akan datang',
      walkthrough: 'Tempah lawatan',
      exploreProduct: 'Terokai {name}',
      seeProducts: 'Lihat produknya',
      compareProducts: 'Banding produk',
      readRoadmap: 'Baca pelan hala tuju',
      joinBeta: 'Sertai senarai beta',
      builtFor: 'Dibina untuk',
      contents: 'Kandungan',
      home: 'Utama',
      logoHome: 'Laman utama BIYY Tech',
    },
    nav: {
      openMenu: 'Buka menu',
    ...
    pillars: {
      eyebrow: 'Kenapa BIYY',
      title: 'Disiplin perusahaan besar, bersaiz perniagaan yang masih kenal setiap pelanggan.',
      body: 'Kebanyakan perisian PKS sama ada mainan atau ERP yang dipotong. Kami bina bahagian tengahnya: ketat di tempat yang penting (reka bentuk skema, jejak audit, kebenaran) dan ringkas tanpa kompromi di tempat lain.',
    },
    industries: {
      eyebrow: 'Siapa yang berjalan atas BIYY',
      title: 'Lantai berbeza. Spreadsheet yang sama.',
      body: 'Dashboard berubah mengikut industri sebab keputusan mingguannya berubah. Fail yang semua orang sedang e-melkan sesama sendiri itu tidak berubah.',
      carouselLabel: 'Industri yang dilayan',
    },
    features: {
      eyebrow: 'Dalam {name}',
      title: 'Empat perkara yang pasukan anda betul-betul sentuh setiap hari.',
    },
    testimonials: {
      eyebrow: 'Dari lantai',
      title: 'Apa yang berubah selepas minggu kedua.',
      carouselLabel: 'Kisah pelanggan',
    },
    comparison: {
      eyebrow: 'Perbandingan yang jujur',
      title: 'Empat cara menjalankan operasi. Ini tempat setiap satu tersasar.',
      headApproach: 'Pendekatan',
      headCost: 'Kos',
      headSpeed: 'Masa untuk berbaloi',
      headVerdict: 'Di mana ia berakhir',
    },
    process: {
      eyebrow: 'Pelaksanaan',
      title: 'Dua minggu. Empat langkah. Tiada perunding menetap di pejabat anda.',
      body: 'Setiap langkah ada pemiliknya, tarikhnya dan takrifan siapnya sebelum kami mula.',
      badge: 'hari dari lawatan sehingga setiap cawangan hidup',
    },
    faq: {
      eyebrow: 'Soalan',
      title: 'Perkara yang orang tanya sebelum mereka setuju.',
      body: 'Kalau soalan anda tiada di sini, tanya semasa lawatan. Kami lebih rela menjawabnya sebelum anda membeli.',
    },
    cta: {
      title: 'Sedia berhenti membina semula laporan yang sama setiap Isnin?',
      body: 'Tiga puluh minit, spreadsheet sebenar anda dibuka, dan jawapan terus terang sama ada BIYY berbaloi untuk perniagaan anda. Tiada slaid pembentangan.',
    },
    carousel: {
      previous: 'Sebelum',
      next: 'Seterusnya',
      wraps: '{label} (berulang)',
    },
    ...
    footer: {
      ...
      whyYiy: 'Kenapa BIYY',
      results: 'Keputusan',
      rollout: 'Cara pelaksanaan berjalan',
      faqLink: 'Soalan lazim',
      support: 'Sokongan',
      rights: '© {year} {legal}. Hak cipta terpelihara.',
      privacy: 'Privasi',
      terms: 'Terma',
      cookies: 'Cookie',
      photography: 'Fotografi melalui Pexels',
    },
    consent: {
      dialogLabel: 'Keutamaan cookie',
      eyebrow: 'Cookie',
      body: 'Laman ini tidak menetapkan cookie penjejakan dan tidak memuatkan skrip pihak ketiga. Kami simpan pilihan di bawah supaya kalau kami pernah menambah analitik, ia hanya berjalan untuk orang yang bersetuju. Menolak tidak mengubah apa-apa tentang apa yang boleh anda baca di sini.',
      policyLink: 'Dasar cookie',
      manage: 'Urus keutamaan',
      rejectAll: 'Tolak semua',
      acceptAll: 'Terima semua',
      save: 'Simpan keutamaan',
      alwaysOn: 'Sentiasa hidup',
      preferencesButton: 'Keutamaan cookie',
      necessaryLabel: 'Perlu sepenuhnya',
      necessaryBody:
        'Menghidangkan halaman dan mengingati pilihan ini. Sentiasa hidup, dan tiada suis untuknya sebab laman ini tidak boleh berfungsi tanpanya.',
      analyticsLabel: 'Analitik',
      analyticsBody:
        'Statistik halaman dan trafik tanpa nama, supaya kami nampak halaman mana yang berbaloi ditulis lagi. Tiada satu pun dimuatkan hari ini.',
      marketingLabel: 'Pemasaran',
      marketingBody:
        'Tag pengiklanan dan pemasaran semula milik syarikat lain. Kami tidak menjalankan satu pun, dan kami lebih suka kekal begitu.',
    },
    chat: {
      dialogLabel: 'Pembantu BIYY',
      name: 'BIYY Bot',
      status: 'pembantu berasaskan peraturan',
      typing: 'sedang menaip…',
      open: 'Buka pembantu',
      close: 'Tutup pembantu',
      nudge: 'Ada soalan tentang dashboard, database atau berpindah daripada spreadsheet? Tanya saya, tanpa perlu isi borang.',
      placeholder: 'Tanya tentang dashboard, migrasi, harga…',
      inputLabel: 'Hantar mesej kepada pembantu',
      send: 'Hantar',
    },
    contact: {
      eyebrow: 'Tempah lawatan',
      title: 'Tiga puluh minit. Spreadsheet anda. Jawapan terus terang.',
      body: 'Kami akan berjalan di lantai atau kaunter depan anda dengan fail anda sendiri dibuka, petakan apa yang direkod dan ke mana ia pergi, dan beritahu anda sama ada BIYY berbaloi untuk perniagaan anda. Kalau tidak berbaloi, kami akan cakap.',
      sentTitle: 'Kami sudah buka satu draf dalam klien e-mel anda.',
      sentBody:
        'Tiada apa sampai kepada kami lagi. Tekan hantar pada draf itu dan kami akan balas dalam satu hari bekerja.',
      noDraftTitle: 'Kalau tiada draf muncul',
      noDraftBody:
        'Sesetengah komputer tiada aplikasi e-mel yang disediakan. Salin pertanyaan itu dan hantar daripada mana-mana tempat anda benar-benar membaca e-mel, kepada',
      copy: 'Salin pertanyaan',
      copied: 'Disalin',
      edit: 'Sunting pertanyaan',
      preamble:
        'Medan bertanda wajib ialah yang kami perlukan untuk membalas. Selebihnya membantu kami datang bersedia.',
      name: 'Nama',
      namePlaceholder: 'Nama anda',
      business: 'Perniagaan',
      businessPlaceholder: 'Nama perniagaan',
      email: 'E-mel',
      emailPlaceholder: 'anda@perniagaan.com',
      phone: 'Telefon / WhatsApp',
      phonePlaceholder: 'Pilihan',
      required: 'wajib',
      interest: 'Berminat dengan',
      size: 'Saiz',
      message: 'Apa yang memakan masa anda sekarang?',
      messagePlaceholder: 'Membina semula laporan mingguan, versi yang tidak sepadan, laporan hujung bulan…',
      submit: 'Hantar pertanyaan',
      disclaimer:
        'Ini membuka draf dalam klien e-mel anda sendiri. Tiada apa dihantar sehingga anda tekan hantar di sana. Tiada senarai berita, tiada urutan pemasaran. Kami balas sekali, daripada manusia.',
      oneError: 'Satu medan masih perlu dibetulkan sebelum kami boleh merangka pertanyaan itu.',
      manyErrors: '{n} medan masih perlu dibetulkan sebelum kami boleh merangka pertanyaan itu.',
      direct: 'Terus',
      coverTitle: 'Apa yang akan kami liputi',
      ...
      sizes: ['1 cawangan', '2–5 cawangan', '6–20 cawangan', '20+ cawangan'],
      errName: 'Beritahu kami siapa anda.',
      errBusiness: 'Ini untuk perniagaan yang mana?',
      errEmail: 'Kami perlukan tempat untuk membalas.',
      errEmailFormat: 'Itu tidak nampak seperti alamat e-mel.',
      errPhone: 'Biarkan kosong, atau beri nombor yang boleh kami dail.',
      mailSubject: 'Permohonan lawatan: {who}',
      mailName: 'Nama',
      mailBusiness: 'Perniagaan',
      mailEmail: 'E-mel',
      mailPhone: 'Telefon',
      mailInterest: 'Berminat dengan',
      mailSize: 'Saiz',
      mailNoMessage: '(tiada mesej)',
    },
    careers: {
      eyebrow: 'Kerjaya',
      title: 'Bina perisian yang menjalankan kedai.',
      body: 'Pasukan kecil di {location}, menggantikan spreadsheet yang perniagaan kecil harapkan setiap hari berniaga. Kalau ayat "versi mana yang betul" membuatkan anda rasa mahu membetulkan sesuatu, kita patut berbual.',
      valuesEyebrow: 'Cara kami bekerja',
      valuesTitle: 'Empat perkara yang kami betul-betul pegang antara satu sama lain.',
      valuesBody:
        'Bukan poster. Ini hujah yang kami bawa dalam semakan kod dan dalam panggilan pelanggan.',
      rolesEyebrow: 'Jawatan kosong',
      rolesTitle: 'Tiada kekosongan buat masa ini.',
      apply: 'Mohon',
      noRoles:
        'Kami tidak mengambil pekerja sekarang. Bila ada kekosongan, ia akan disenaraikan di sini dahulu, dengan julat gaji, lokasi dan gambaran sebenar sembilan puluh hari pertama.',
      speculativeBefore: 'Kalau anda rasa anda patut ada di sini juga, hantar',
      // Follows an email link. Malay behaves like English here and carries its
      // own leading space, unlike Chinese which runs straight into its comma.
      speculativeAfter:
        ' satu perenggan tentang sesuatu yang anda bina dan kenapa ia sukar. Kami baca kesemuanya, dan yang bagus kami simpan.',
      notifyMe: 'Beritahu saya bila ada kekosongan',
      speculativeSubject: 'Permohonan terbuka',
      applicationSubject: 'Permohonan: {role}',
      teamAlt: 'Pasukan BIYY Tech sedang bekerja',
      perks: [
        {
          title: 'Onboarding empat hari',
          body: 'Empat hari pertama anda dihabiskan di gudang pelanggan dan di kaunter depan, bukan dalam wiki.',
        },
        {
          title: 'Hantar dalam minggu pertama',
          body: 'Setiap orang menggabungkan sesuatu yang pelanggan sentuh dalam minggu pertama mereka.',
        },
        {
          title: 'Perkakasan pilihan anda',
          body: 'Pilih komputer dan telefon anda. Kami beli Android murah juga, sebab pelanggan guna yang itu.',
        },
        {
          title: 'Waktu kerja yang jujur',
          body: 'Tiada kerja mati-matian minggu pelancaran. Pelaksanaan dirancang supaya tiada siapa perlu tidur bawah meja.',
        },
      ],
    },
    industryIndex: {
      eyebrow: 'Industri',
      title: 'Dua belas lantai yang susunannya sudah pun kami bina.',
      body: 'Database di bawahnya sama. Yang berubah ialah skrin pertama, sebab pengedar, klinik dan kedai gunting tidak membuat keputusan yang sama pada hari Isnin. Pilih yang anda kenal.',
      cardCta: 'Lihat dashboardnya',
      notListed: 'Tiada dalam senarai ini?',
      notListedBody:
        'Kami bina susunannya daripada apa yang anda putuskan setiap minggu, jadi industri yang belum ada halamannya bermakna satu lawatan, bukan satu penolakan. Beritahu kami bidangnya dan tiga angka yang paling kerap anda semak, dan kami akan beritahu dengan jujur sama ada kami orang yang betul.',
    },
    industry: {
      eyebrow: 'Industri',
      painsEyebrow: 'Apa yang ia gantikan',
      painsTitle: 'Cara ini biasanya berjalan hari ini.',
      painsBody:
        'Ditulis daripada lawatan sebenar, bukan daripada dokumen persona. Kalau tiada satu pun benar bagi anda, sebut semasa panggilan dan kami berhenti membazir petang anda.',
      panelsEyebrow: 'Skrin pertama',
      panelsTitle: 'Apa yang dashboard buka.',
      panelsBody:
        'Setiap panel terikat pada keputusan yang seseorang buat mengikut rentak yang diketahui. Apa sahaja yang hanya mengulang apa yang anda sudah tahu tidak akan dihantar.',
      crossEyebrow: 'Lantai lain',
      crossTitle: 'Kaedah sama, skrin pertama berbeza.',
      faqEyebrow: 'Soalan',
      faqTitle: 'Ditanya dalam setiap panggilan seperti ini.',
      faqBody: 'Kalau soalan anda tiada di sini, tanya semasa lawatan. Kami lebih rela menjawab sebelum anda komit.',
      heroAlt: 'Perniagaan {name} sedang beroperasi',
    },
    dash: {
      valueEyebrow: 'Apa nilainya',
      valueTitle: 'Apa yang berubah dalam minggu bekerja.',
      valueBody:
        'Bukan senarai ciri. Apa yang berbeza sebaik data tinggal di satu tempat dan skrin itu sudah pun betul bila seseorang membukanya.',
      limitsEyebrow: 'Hadnya',
      limitsTitle: 'Apa yang kami tidak buat.',
      limitsBody: 'Lebih baik disebut di sini daripada ditemui pada bulan kedua.',
      faqEyebrow: 'Soalan',
      faqTitle: 'Ditanya dalam setiap panggilan seperti ini.',
      faqBody:
        'Kalau soalan anda tiada di sini, tanya semasa lawatan. Kami lebih rela menjawab sebelum anda komit.',
      bandAlt: 'Dashboard operasi dibuka atas komputer riba di pejabat belakang',
    },
    web: {
    ...
    ai: {
      bandAlt: 'Pejabat belakang tempat rekod yang dibaca model itu dimasukkan',
      valueEyebrow: 'Apa nilainya',
      valueTitle: 'Apa yang berubah sebaik satu jawapan hanya berharga satu ayat.',
      valueBody:
        'Bukan nama model dan bilangan parameter. Apa yang berbeza dalam seminggu sebaik separuh kerja berulang itu sudah dirangka, disemak dan dihalakan sebelum sesiapa membukanya.',
      connectEyebrow: 'Sempadannya',
      connectTitle: 'Apa yang model boleh baca, dan apa yang ia dibenarkan tulis.',
      connectBody:
        'Soalan pertama dalam setiap panggilan seperti ini, dijawab di sini dan bukan dalam perjanjian tiga minggu kemudian. Bacaan mengikut kebenaran yang pasukan anda sudah ada; tiada apa dalam lajur tulis sampai ke satu rekod tanpa melepasi ambang keyakinannya.',
      headSurface: 'Permukaan',
      headReads: 'Baca daripada BIYY',
      headWrites: 'Tulis balik ke BIYY',
      none: '—',
      stagesEyebrow: 'Cara projek berjalan',
      stagesTitle: 'Empat minggu, dan ia hidup dengan menyemak sebelum ia hidup dengan mengomit.',
      stagesBody:
        'Setiap peringkat ada pemiliknya, dan peringkat di tengah itu wujud supaya benda ini diukur terhadap jawapan yang sudah diketahui sebelum sesiapa bergantung padanya.',
      limitsEyebrow: 'Hadnya',
      limitsTitle: 'Apa yang kami tidak buat.',
      limitsBody: 'Lebih baik disebut di sini daripada ditemui pada bulan kedua.',
      faqEyebrow: 'Soalan',
    ...
    blog: {
      eyebrow: 'Blog',
      title: 'Nota lapangan dari lantai.',
      body: 'Apa yang kami pelajari semasa memindahkan perniagaan keluar daripada spreadsheet ketika mereka tidak mampu menanggung satu minggu yang buruk. Database, dashboard, harga, dan perkara yang rosak sebelum ia menjadi.',
      readPiece: 'Baca artikel',
      moreWriting: 'Tulisan lain',
      policyTitle: 'Cara kami menulis ini',
      policyBody:
        'Artikel ditulis oleh orang yang membuat kerjanya, bukan oleh pasukan kandungan. Setiap satu menyatakan siapa yang menulisnya, apa kelayakannya, bila ia terakhir disemak dan dari mana angkanya datang, termasuk had sampelnya. Kalau anda jumpa kesilapan, tulis kepada',
      policyBodyAfter: ' dan kami akan betulkan serta catat perubahannya.',
      // The posts themselves are still in English — see the note at the top of
      // site.ms.js. This line sits above the list so a Malay reader is told
      // that before they click, rather than discovering it on the article.
      languageNote:
        'Artikel penuh masih dalam bahasa Inggeris buat masa ini. Kami menterjemahkannya hanya selepas seorang penyemak yang membaca Melayu meneliti angka di dalamnya.',
    },
    post: {
      shortAnswer: 'Jawapan ringkasnya',
      takeaways: 'Perkara utama',
      aboutAuthor: 'Tentang penulis',
      reviewedBy: 'Disemak oleh {name}, {role}.',
      faqHeading: 'Soalan lazim',
      sources: 'Rujukan',
      keepReading: 'Terus membaca',
      published: 'Diterbitkan',
      reviewed: 'Disemak',
      readTime: 'bacaan {time}',
      correctionsBefore: 'Nampak sesuatu yang salah? Tulis kepada',
    },
    product: {
      whatEyebrow: 'Apa yang anda dapat',
      whatTitle: 'Semua yang {name} buat pada hari pertama.',
      whatBody:
        'Dibina untuk {audience}, dikonfigurasikan mengikut cawangan, peranan dan peraturan kelulusan anda semasa onboarding.',
      seeAll: 'Lihat semua produk',
      crossEyebrow: 'Juga daripada BIYY',
      crossTitle: 'Selebihnya lapisan operasi.',
      heroAlt: '{name} dalam persekitaran kerja',
      inUseAlt: '{name} sedang digunakan',
    },
    legal: {
      askUs: 'Tanya kami',
    ...
    notFound: {
      title: 'Halaman itu tiada atas rak.',
      body: 'Pautannya rosak atau halaman itu sudah berpindah. Kembali ke produk, atau beritahu kami apa yang anda cari.',
